...
export default function NavigationTabs({
  ...
  const navItemClass = (isActive) =>
    `flex flex-col md:flex-row items-center justify-center flex-1 md:flex-none w-full py-2 md:py-4 ${settings.isSidebarCollapsed ? 'md:px-0 md:justify-center' : 'md:px-6 md:justify-start'} space-y-1 md:space-y-0 ${settings.isSidebarCollapsed ? 'md:space-x-0' : 'md:space-x-4'} transition-colors cursor-pointer md:border-l-4 rounded-full md:rounded-none ${
      isActive
        ? "text-blue-600  dark:text-blue-400 bg-blue-50/50  dark:bg-gray-900/50 border-transparent md:border-blue-600 dark:md:border-blue-400"
        : "text-gray-500 hover:text-gray-900  dark:hover:text-gray-200 dark:text-gray-400 dark:hover:text-gray-200 border-transparent"
    }`;
      ...
      >
        ...
        <div className={`hidden md:flex flex-col w-full p-4 mb-2 border-b border-gray-200  dark:border-gray-800 pt-6 ${settings.isSidebarCollapsed ? 'items-center' : ''}`}>
          {settings.isSidebarCollapsed ? (
            <div className="flex flex-col items-center gap-4 w-full mb-4">
              ...
              <button
                ...
                className="p-1.5 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:bg-gray-800 transition-colors flex items-center justify-center"
            ...
            <div className="flex flex-col w-full mb-4">
              <div className="flex justify-between items-start w-full">
                <div className="flex flex-col items-start gap-2">
                  <img src={currentIcon} alt="Logo" className="w-8 h-8 rounded-lg object-contain shadow-sm" />
                  <div>
                    <h2 className="text-xl font-bold text-gray-900  dark:text-white tracking-tight">AmazeCC</h2>
                ...
                <div className="flex items-center gap-1.5 pt-1">
                  ...
                  <button
                    ...
                    className={`p-1.5 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:bg-gray-800 transition-colors flex items-center justify-center ${activeTab === "profile" ? "bg-blue-50  dark:bg-gray-900/50" : ""}`}
                    title="Profile"
                  >
          ...
          {!settings.isSidebarCollapsed && (
            ...
            {/* CGPA */}
            <div
              className="flex flex-col items-center justify-center p-2 rounded-xl bg-gray-50  dark:bg-gray-800/50 border border-gray-100  dark:border-gray-700 cursor-pointer hover:shadow-sm transition-all group"
            ...
            >
              ...
              <span className="font-bold text-sm text-gray-900  dark:text-gray-100 group-hover:text-blue-500 transition-colors">
          ...
          {feedbackStatus && (
            <div onClick={onOpenFeedbackStatus} className="flex flex-col mt-2 pt-3 border-t border-gray-100  dark:border-gray-800 cursor-pointer hover:bg-gray-50 dark:hover:bg-slate-800/30 dark:hover:bg-gray-800/30 rounded-lg px-2 -mx-2 transition-colors">
        ...
        {activeTab === "attendance" && !settings.isSidebarCollapsed && (
          <div className="hidden md:flex flex-col w-full pl-12 pr-4 py-1 space-y-1 bg-white  dark:bg-black">
            <button
              onClick={() => setActiveAttendanceSubTab("attendance")}
              className={`text-left text-sm py-1.5 transition-colors ${activeAttendanceSubTab === "attendance" ? "text-blue-600  dark:text-blue-400 font-medium" : "text-gray-500 hover:text-gray-900 dark:hover:text-gray-200 dark:hover:text-gray-200"}`}
            >
              Attendance
            </button>
            <button
              onClick={() => setActiveAttendanceSubTab("calendar")}
              className={`text-left text-sm py-1.5 transition-colors ${activeAttendanceSubTab === "calendar" ? "text-blue-600  dark:text-blue-400 font-medium" : "text-gray-500 hover:text-gray-900 dark:hover:text-gray-200 dark:hover:text-gray-200"}`}
            >
              Calendar
            </button>
          </div>
        ...
        {activeTab === "academics" && !settings.isSidebarCollapsed && (
          <div className="hidden md:flex flex-col w-full pl-12 pr-4 py-1 space-y-1 bg-white  dark:bg-black">
            <button
              ...
              className={`text-left text-sm py-1.5 transition-colors ${activeSubTab === "overview" ? "text-blue-600  dark:text-blue-400 font-medium" : "text-gray-500 hover:text-gray-900 dark:hover:text-gray-200 dark:hover:text-gray-200"}`}
            >
              Overview
            </button>
            <button
              onClick={() => setActiveSubTab("course-dashboard")}
              className={`text-left text-sm py-1.5 transition-colors ${activeSubTab === "course-dashboard" ? "text-blue-600  dark:text-blue-400 font-medium" : "text-gray-500 hover:text-gray-900 dark:hover:text-gray-200 dark:hover:text-gray-200"}`}
            >
              Course Dashboard
            </button>
            <button
              onClick={() => setActiveSubTab("grades")}
              className={`text-left text-sm py-1.5 transition-colors ${activeSubTab === "grades" ? "text-blue-600  dark:text-blue-400 font-medium" : "text-gray-500 hover:text-gray-900 dark:hover:text-gray-200 dark:hover:text-gray-200"}`}
            >
              Grade History
            </button>
            <button
              onClick={() => setActiveSubTab("curriculum")}
              className={`text-left text-sm py-1.5 transition-colors ${activeSubTab === "curriculum" ? "text-blue-600  dark:text-blue-400 font-medium" : "text-gray-500 hover:text-gray-900 dark:hover:text-gray-200 dark:hover:text-gray-200"}`}
            >
              Curriculum
            </button>
            <button
              onClick={() => setActiveSubTab("predictor")}
              className={`text-left text-sm py-1.5 transition-colors ${activeSubTab === "predictor" ? "text-blue-600  dark:text-blue-400 font-medium" : "text-gray-500 hover:text-gray-900 dark:hover:text-gray-200 dark:hover:text-gray-200"}`}
            >
              CGPA Predictor
            </button>
            <button
              onClick={() => setActiveSubTab("qbank")}
              className={`text-left text-sm py-1.5 transition-colors ${activeSubTab === "qbank" ? "text-blue-600  dark:text-blue-400 font-medium" : "text-gray-500 hover:text-gray-900 dark:hover:text-gray-200 dark:hover:text-gray-200"}`}
            >
              Question Bank
            </button>
            ...
            <button
              ...
              className={`text-left text-sm py-1.5 transition-colors ${activeSubTab === "arrear" ? "text-blue-600  dark:text-blue-400 font-medium" : "text-gray-500 hover:text-gray-900 dark:hover:text-gray-200 dark:hover:text-gray-200"}`}
            >
              Arrear
            </button>
            <button
              onClick={() => setActiveSubTab("makeup-compre")}
              className={`text-left text-sm py-1.5 transition-colors ${activeSubTab === "makeup-compre" ? "text-blue-600  dark:text-blue-400 font-medium" : "text-gray-500 hover:text-gray-900 dark:hover:text-gray-200 dark:hover:text-gray-200"}`}
            >
              Makeup & Compre
            </button>
            <button
              onClick={() => setActiveSubTab("course-mgmt")}
              className={`text-left text-sm py-1.5 transition-colors ${activeSubTab === "course-mgmt" ? "text-blue-600  dark:text-blue-400 font-medium" : "text-gray-500 hover:text-gray-900 dark:hover:text-gray-200 dark:hover:text-gray-200"}`}
            >
              Course Mgmt
            </button>
            <button
              onClick={() => setActiveSubTab("projects")}
              className={`text-left text-sm py-1.5 transition-colors ${activeSubTab === "projects" ? "text-blue-600  dark:text-blue-400 font-medium" : "text-gray-500 hover:text-gray-900 dark:hover:text-gray-200 dark:hover:text-gray-200"}`}
            >
              Projects
            </button>
            <button
              onClick={() => setActiveSubTab("wishlist")}
              className={`text-left text-sm py-1.5 transition-colors ${activeSubTab === "wishlist" ? "text-blue-600  dark:text-blue-400 font-medium" : "text-gray-500 hover:text-gray-900 dark:hover:text-gray-200 dark:hover:text-gray-200"}`}
            >
              Wishlist
            </button>
            <button
              onClick={() => setActiveSubTab("faculty-info")}
              className={`text-left text-sm py-1.5 transition-colors ${activeSubTab === "faculty-info" ? "text-blue-600  dark:text-blue-400 font-medium" : "text-gray-500 hover:text-gray-900 dark:hover:text-gray-200 dark:hover:text-gray-200"}`}
            >
              Faculty Info
            </button>
            ...
            {activeTab === "hostel" && !settings.isSidebarCollapsed && (
              <div className="hidden md:flex flex-col w-full pl-12 pr-4 py-1 space-y-1 bg-white  dark:bg-black">
                <button
                  ...
                  className={`text-left text-sm py-1.5 transition-colors ${HostelActiveSubTab === "mess" ? "text-blue-600  dark:text-blue-400 font-medium" : "text-gray-500 hover:text-gray-900 dark:hover:text-gray-200 dark:hover:text-gray-200"}`}
                >
                  Mess
                </button>
                <button
                  onClick={() => setHostelActiveSubTab("laundry")}
                  className={`text-left text-sm py-1.5 transition-colors ${HostelActiveSubTab === "laundry" ? "text-blue-600  dark:text-blue-400 font-medium" : "text-gray-500 hover:text-gray-900 dark:hover:text-gray-200 dark:hover:text-gray-200"}`}
                >
                  Laundry
                </button>
                <button
                  onClick={() => setHostelActiveSubTab("leave")}
                  className={`text-left text-sm py-1.5 transition-colors ${HostelActiveSubTab === "leave" ? "text-blue-600  dark:text-blue-400 font-medium" : "text-gray-500 hover:text-gray-900 dark:hover:text-gray-200 dark:hover:text-gray-200"}`}
                >
                  Leave
                </button>
                <button
                  onClick={() => setHostelActiveSubTab("counselling")}
                  className={`text-left text-sm py-1.5 transition-colors ${HostelActiveSubTab === "counselling" ? "text-blue-600  dark:text-blue-400 font-medium" : "text-gray-500 hover:text-gray-900 dark:hover:text-gray-200 dark:hover:text-gray-200"}`}
                >
                  Counselling
                </button>
              </div>
        ...
        {activeTab === "more" && !settings.isSidebarCollapsed && (
          <div className="hidden md:flex flex-col w-full pl-12 pr-4 py-1 space-y-1 bg-white  dark:bg-black">
            <button
              ...
              className={`text-left text-sm py-1.5 transition-colors ${activeMoreSubTab === "social" ? "text-blue-600  dark:text-blue-400 font-medium" : "text-gray-500 hover:text-gray-900 dark:hover:text-gray-200 dark:hover:text-gray-200"}`}
            >
              Social
            </button>
            <button
              onClick={() => setActiveMoreSubTab("ffcs")}
              className={`text-left text-sm py-1.5 transition-colors ${activeMoreSubTab === "ffcs" ? "text-blue-600  dark:text-blue-400 font-medium" : "text-gray-500 hover:text-gray-900 dark:hover:text-gray-200 dark:hover:text-gray-200"}`}
            >
              FFCS Planner
            </button>
            <button
              onClick={() => setActiveMoreSubTab("events")}
              className={`text-left text-sm py-1.5 transition-colors ${activeMoreSubTab === "events" ? "text-blue-600  dark:text-blue-400 font-medium" : "text-gray-500 hover:text-gray-900 dark:hover:text-gray-200 dark:hover:text-gray-200"}`}
            >
              Event Hub
            </button>
          </div>
        ...
        {activeTab === "profile" && !settings.isSidebarCollapsed && (
          <div className="hidden md:flex flex-col w-full pl-12 pr-4 py-1 space-y-1 bg-white  dark:bg-black">
            <button
              ...
              className={`text-left text-sm py-1.5 transition-colors ${activeProfileSubTab === "info" ? "text-blue-600  dark:text-blue-400 font-medium" : "text-gray-500 hover:text-gray-900 dark:hover:text-gray-200 dark:hover:text-gray-200"}`}
            >
              My Info
            </button>
            <button
              onClick={() => setActiveProfileSubTab("credentials")}
              className={`text-left text-sm py-1.5 transition-colors ${activeProfileSubTab === "credentials" ? "text-blue-600  dark:text-blue-400 font-medium" : "text-gray-500 hover:text-gray-900 dark:hover:text-gray-200 dark:hover:text-gray-200"}`}
            >
              Credentials
            </button>
          </div>
