...
export default function ShareScheduleModal({
  ...
  return (
    <Modal onClose={onClose} title="Share Schedule">
      ...
      <div className="bg-white  dark:bg-black p-4 rounded-xl shadow-md mb-4 flex justify-center">
        <QRCodeSVG value={code} size={180} />
      </div>

      <div className="bg-gray-50  dark:bg-gray-900/50 rounded-xl p-3 mb-4">
        <p className="text-xs font-mono text-gray-600  dark:text-gray-400 truncate select-all" title={code}>
